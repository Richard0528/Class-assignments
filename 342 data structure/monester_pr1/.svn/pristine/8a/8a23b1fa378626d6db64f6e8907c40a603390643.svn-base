...
import mysetpackage.ArraySetSorted;

/**
 * JUnit test of ArraySetSorted
 * @author richardyang
 * @version 1.15
 */
public class ArraySetSortedTest {

	private ArraySetSorted<String> al;//array list
	
	@Before
	public final void setup() {
		//al = new ArrayListUnsorted<String>();
		al = new ArraySetSorted<String>(2);
	}
	...
	public final void zeroCapacity() {
		al = new ArraySetSorted<String>(0);
	}
	...
	public final void negativeCapacity() {
		al = new ArraySetSorted<String>(-1);
	}
	...
	/**
	 * test insert by insert 2 same elements
	 */
	@Test
	public final void insert2N() {
		al.insert("aaa");
		al.insert("aaa");
		assertEquals("insert 1 fail", "[aaa]", al.toString());
	}
	...
	public final void getIndex205Tail() {
		for (int i = 0; i < 205; i++)
			al.insert("str" + i);
		assertEquals("get 1 index tail fail", 204, al.getIndex("str99"));	
	}
	...
	public final void get205Tail() {
		for (int i = 0; i < 205; i++)
			al.insert("str" + i);
		assertEquals("get 205 tail fail", "str99", al.get(204));
	}
	...
	public final void get205Middle() {
		for (int i = 0; i < 205; i++)
			al.insert("str" + i);
		assertEquals("get 205 middle fail", "str19", al.get(101));
	}

...
import mysetpackage.LinkedSetSorted;

/**
 * JUnit test of LinkedSetSorted
 * @author richardyang
 * @version 1.10
 */
public class LinkedSetSortedTest {

	private LinkedSetSorted<String> al;//array list
	
	@Before
	public final void setup() {
		al = new LinkedSetSorted<String>();
	}

...
import mysetpackage.LinkedSetUnsorted;

/**
 * JUnit test of LinkedSetUnsorted
 * @author richardyang
 * @version 1.9
 */
public class LinkedSetUnsortedTest {

	private LinkedSetUnsorted<String> al;//array list
	
	@Before
	public final void setup() {
		al = new LinkedSetUnsorted<String>();
	}

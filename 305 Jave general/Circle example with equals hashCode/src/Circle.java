 ...
 * TCSS 305
 * 
 * An updated Circle example to show equals(), hashCode(), and clone
 */
...
public class Circle {
     ...
     * {@inheritDoc}
     * 
     * This method compares the radius, center point, and color to determine the equality
     * of Circle objects. All three fields must be equal for 2 Circle objects to be
     * considered equal.
     */
    @Override
    public boolean equals(final Object theOther) {
        ...
        if (this == theOther) {
            ...
            final Circle otherCircle = (Circle) theOther;
            
            returnValue = Double.compare(myRadius, otherCircle.myRadius) == 0
                       && Objects.equals(myColor, otherCircle.myColor)
                       && Objects.equals(myCenter, otherCircle.myCenter);
        } 
    ...
    @Override    
    public int hashCode() {
        return Objects.hash(myRadius, myColor, myCenter);
    }

...
public class SwingTestPanel extends JPanel implements FocusListener, MouseListener {
    ...
    static class MyMessageBox extends JPanel implements FocusListener, MouseListener {
        MyMessageBox(){
            initialize();
            addMouseListener(this);
            addFocusListener(this);
